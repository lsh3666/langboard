...
import yaml
from . import pydantic_patch  # noqa: F401
from .format import DatetimeClassType, PythonVersion, PythonVersionMin
from .parser import DefaultPutDict, LiteralType
from .util import SafeLoader
...
if TYPE_CHECKING:
    ...
    from .model.pydantic_v2 import UnionMode
...
def generate(  # noqa: PLR0912, PLR0913, PLR0914, PLR0915
    ...
    *,
    ...
    if isinstance(input_, str):
        ...
        from .http import get_body  # noqa: PLC0415
    ...
    if input_file_type == InputFileType.OpenAPI:  # noqa: PLR1702
        from .parser.openapi import OpenAPIParser  # noqa: PLC0415

        parser_class: type[Parser] = OpenAPIParser
        kwargs["openapi_scopes"] = openapi_scopes
    elif input_file_type == InputFileType.GraphQL:
        raise NotImplementedError("GraphQL is not supported yet")
    else:
        from .parser.jsonschema import JsonSchemaParser  # noqa: PLC0415
    ...
    from .model import get_data_model_types  # noqa: PLC0415
