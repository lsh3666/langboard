...
from .arguments import DEFAULT_ENCODING, arg_parser, namespace
from .format import (
    DatetimeClassType,
    PythonVersion,
    PythonVersionMin,
)
from .model.pydantic_v2 import UnionMode  # noqa: TC001 # needed for pydantic
from .parser import LiteralType  # noqa: TC001 # needed for pydantic
from .reference import is_url
from .types import StrictTypes  # noqa: TC001 # needed for pydantic
from .util import (
    PYDANTIC_V2,
    ConfigDict,
    Model,
...
def main(args: Sequence[str] | None = None) -> Exit:  # noqa: PLR0911, PLR0912, PLR0915
    ...
    if namespace.version:
        from . import get_version  # noqa: PLC0415
