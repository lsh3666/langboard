...
from .....domain.models import ApiKeyRole
from .BaseRoleRepository import BaseRoleRepository


class ApiKeyRoleRepository(BaseRoleRepository[ApiKeyRole]):
    @staticmethod
    def model_cls():
        return ApiKeyRole
    ...
    @extract_func_param(4)(ApiKeyRole)  # type: ignore
    ...
    @extract_func_param(3)(ApiKeyRole)  # type: ignore
